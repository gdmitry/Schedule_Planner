...
(function ($) {
    ...
    $.fn.bxSlider = function (options) {
        ...
        var populatePager = function () {
            ...
            slider.pagerEl.html('');
            slider.controls.next = $('<div class="bx-pager-item"><a class="bx-next" href="">' + slider.settings.nextText + '</a></div>');
            slider.controls.prev = $('<div class="bx-pager-item"><a class="bx-prev" href="">' + slider.settings.prevText + '</a></div>');
            // bind click actions to the controls
            slider.controls.next.bind('click touchend', clickNextBind);
            slider.controls.prev.bind('click touchend', clickPrevBind);
            slider.pagerEl.append(slider.controls.prev);
            ...
            for (var i = 0; i < pagerQty; i++) {
                ...
                slider.pagerEl.append($('<div class="bx-pager-item"><a href="" data-slide-index="' + i + '" class="bx-pager-link">' + linkContent + '</a></div>'));
            }
            slider.pagerEl.append(slider.controls.next);
        };
        ...
        var updatePagerActive = function (slideIndex) {
            ...
            slider.pagerEl.find('.bx-pager-link').removeClass('active');
            // apply the active class for all pagers
            slider.pagerEl.each(function (i, el) {
                $(el).find('.bx-pager-link').eq(slideIndex).addClass('active');
            });
        };
